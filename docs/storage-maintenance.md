...
| Completed server upload staging | Successful append/finalization removes that producer's partial file. An append retry also removes it after verifying the completed object. A status read alone does not reclaim it. |
